...
# Open CSV file to save tracking data
csv_file = open("tacticam_tracking.csv", mode='w', newline='')
...
while True:
    ...
    cv2.imshow("Tacticam Tracking + CSV", frame)
    if cv2.getWindowProperty("Tacticam Tracking + CSV", cv2.WND_PROP_VISIBLE) < 1:
        break
